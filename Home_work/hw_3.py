...
list = ["Bishkek", "Osh", "Talas", "Naryn", "Baky", "Karakol", "Batken","Moscow", "Piter", "Tallin", "London", "Astana", "Tokio", "Tokmok", "Ancara"]
print(list[2:7]) 
...
print(statistics.mean(numbers))  #31.31578947368421
...
#3 раза встречается 110
print(numbers.count(110)) #3 раза
...
# 9)
#  Создайте плейлист из 10 любимых песен, поменяйте 4-й с 8-м и выведите на экран весь плейлист
my_list = ["Roses", "Доча", "Hoodak", "Mood", "99 Problems", "Sway", "Белые розы", "Детство","Седая ночь", "Ego" ]  
a = my_list[4]
my_list[4]=my_list[8]
my_list[8]=a
print(my_list)